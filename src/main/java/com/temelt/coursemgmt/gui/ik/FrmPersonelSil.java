 ...
 * @author user
 */
public class FrmPersonelSil extends javax.swing.JDialog {

    /**
     * Creates new form FrmPersonelSil
     */
    public FrmPersonelSil(java.awt.Frame parent, boolean modal,Personel personel) {
        super(parent, modal);
        initComponents();
    ...
    private void btnOnayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOnayActionPerformed
        ...
        ps.delete(ps.getById( Long.parseLong(valueInCell) ));
        this.dispose();
